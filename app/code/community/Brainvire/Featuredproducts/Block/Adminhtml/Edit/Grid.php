...
*/
class Brainvire_Featuredproducts_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    /*
     * call featuredproducts using ajax and setting rowclick call back for them
     * 
     */
    public function __construct() {
        parent::__construct();

        $this->setId('brainvire_featured_products');
    ...
    /*
     * Adding the column filter to data collection
     * 
     */
    ...
    /*
     * preparing the collection of product data
     * 
     */
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToSelect('brainvire_featured_product')
    ...
    protected function _getSelectedProducts($json=false) {
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ->joinAttribute('brainvire_featured_product', 'catalog_product/brainvire_featured_product', 'entity_id', null, 'left', $store->getId())
                ->addAttributeToFilter('brainvire_featured_product', '1');
...
EndHTML;
    ...
    private function _appendHtml() {
		...
		var checkbox_all = $$("#brainvire_featured_products_table thead input.checkbox").first();
    	var everycheckbox = $$("#brainvire_featured_products_table tbody input.checkbox");
